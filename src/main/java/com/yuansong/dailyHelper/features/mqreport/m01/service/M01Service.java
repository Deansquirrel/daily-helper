...
public class M01Service {
    ...
    public List<M01Do> getMData(Date queryMonth) {
        if(queryMonth == null) {
    ...
    public WorkTableData getMDataTable(List<M01Do> list) {
        if(list == null) {
            list = new ArrayList<>();
        }
        return WorkBookTool.getXSSFWorkTable("职工参保", list, new M01DataMapper());
    }
