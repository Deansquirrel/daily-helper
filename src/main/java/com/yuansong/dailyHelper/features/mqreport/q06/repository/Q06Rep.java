...
public class Q06Rep {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Q06Rep.class);
    ...
    public Q06Rep(@Qualifier(Constant.BEAN_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
    ...
    public List<Q06Do> getList(Q06Query query) {
        ...
        logger.debug(MessageFormat.format("Q06 SQL {0} {1} {2}",SQL_QUERY, minSetlTime,maxSetlTime));
