...
public class Q28Rep {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Q28Rep.class);
    ...
    public Q28Rep(@Qualifier(Constant.BEAN_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
    ...
    public List<Q28Do> getList(Q28Query query) {
        ...
        logger.debug(MessageFormat.format("Q28 SQL {0} {1} {2}",SQL_QUERY, minSetlTime,maxSetlTime));
