...
//        mqReportService.getAllQFile(cal.getTime());
    ...
    @ApiOperation(value="SI大额参保人数")
    @RequestMapping(value="/q40",method = RequestMethod.GET)
    public ResponseResult<?> getQ40Data() {
        mqReportService.getQ40File(null);
        return Response.makeOKResp();
    }

    @ApiOperation(value="居民普通门诊、慢特病、和住院人数")
    @RequestMapping(value="/q41",method = RequestMethod.GET)
    public ResponseResult<?> getQ41Data() {
        mqReportService.getQ41File(null);
        return Response.makeOKResp();
    }

    @ApiOperation(value="异地备案人次")
    @RequestMapping(value="/q42",method = RequestMethod.GET)
    public ResponseResult<?> getQ42Data() {
        mqReportService.getQ42File(null);
        return Response.makeOKResp();
    }
