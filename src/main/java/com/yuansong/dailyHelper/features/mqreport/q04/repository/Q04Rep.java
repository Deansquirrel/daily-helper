...
import com.yuansong.dailyHelper.features.mqreport.q03.repository.Q03RowMapper;
...
public class Q04Rep {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Q04Rep.class);
    ...
    public Q04Rep(@Qualifier(Constant.BEAN_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
    ...
    public List<Q04Do> getList(Q04Query query) {
        ...
        logger.debug(MessageFormat.format("Q04 SQL {0} {1} {2}",SQL_QUERY, minSetlTime,maxSetlTime));
