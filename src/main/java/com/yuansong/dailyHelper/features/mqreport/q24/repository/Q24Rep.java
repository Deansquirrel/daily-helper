...
public class Q24Rep {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Q24Rep.class);
    ...
    public Q24Rep(@Qualifier(Constant.BEAN_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
    ...
    public List<Q24Do> getList(Q24Query query) {
        ...
        logger.debug(MessageFormat.format("Q24 SQL {0} {1} {2}",SQL_QUERY, minSetlTime,maxSetlTime));
