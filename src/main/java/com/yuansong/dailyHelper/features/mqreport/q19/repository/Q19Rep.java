...
public class Q19Rep {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Q19Rep.class);
    ...
    public Q19Rep(@Qualifier(Constant.BEAN_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
    ...
    public List<Q19Do> getList(Q19Query query) {
        ...
        logger.debug(MessageFormat.format("Q19 SQL {0} {1} {2}",SQL_QUERY, minSetlTime,maxSetlTime));
