...
public class Q15Rep {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Q15Rep.class);
    ...
    public Q15Rep(@Qualifier(Constant.BEAN_JDBC_TEMPLATE) JdbcTemplate jdbcTemplate) {
    ...
    public List<Q15Do> getList(Q15Query query) {
        ...
        logger.debug(MessageFormat.format("Q15 SQL {0} {1} {2}",SQL_QUERY, minSetlTime,maxSetlTime));
