...
@Component("FeatureToolBean")
public class FeatureToolBean {

    private final ISwaggerConfig swaggerConfig;

    public FeatureToolBean(ISwaggerConfig swaggerConfig) {
        this.swaggerConfig = swaggerConfig;
    }

    @Bean("FeatureToolDocket")
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title(this.swaggerConfig == null ? "Tool"
                        : this.swaggerConfig.getTitle() == null ? "Tool"
